...
// Shimmer skeleton element with gradient animation
...
export const InsightCardSkeleton = () => {
  return (
    <Card className="rounded-xl border border-border bg-card shadow-sm overflow-hidden max-w-full">
      <CardContent className="p-0 rounded-xl overflow-hidden">
        {/* Media skeleton - matches image/video area */}
        <ShimmerBlock className="w-full h-48 md:h-40 rounded-none" />
        
        {/* Content section */}
        <div className="p-4 md:p-3.5">
          {/* Author info skeleton */}
          <div className="flex items-center gap-3 md:gap-2 mb-3 md:mb-2">
            <ShimmerBlock className="w-10 h-10 md:w-8 md:h-8 rounded-full shrink-0" />
          ...
          {/* Title skeleton */}
          <ShimmerBlock className="h-5 w-full mb-2 md:mb-1.5" />
          <ShimmerBlock className="h-5 w-3/4 mb-2 md:mb-1.5" />
          
          {/* Preview text skeleton */}
          <ShimmerBlock className="h-4 w-full mb-1" />
          <ShimmerBlock className="h-4 w-2/3 mb-3 md:mb-2" />
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2 md:gap-1">
              <ShimmerBlock className="h-9 md:h-7 w-16 rounded-md" />
              <ShimmerBlock className="h-9 md:h-7 w-14 rounded-md" />
            </div>
          </div>
        </div>
      </CardContent>
