...
import { Search, X, Mic, TrendingUp, Clock, Heart } from 'lucide-react';
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <Button
        ...
        className="relative h-12 w-12 md:h-14 md:w-14 rounded-2xl flex-shrink-0 border-border/50 hover:border-primary/50 hover:bg-primary/5 transition-all"
        title="View Wishlist"
      >
        <Heart className="h-5 w-5 text-muted-foreground" />
        {wishlistCount > 0 && (
          <Badge 
            className="absolute -top-1 -right-1 h-5 min-w-[20px] px-1.5 text-xs bg-red-500 text-white border-0"
          >
